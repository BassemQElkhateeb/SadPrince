...
public class Player extends Entity{
    ...
    public void update(){
        ...
        {
            //Create new weapon constructor every time a weapon is used, this is done because I do not know
            // a better way that would constantly reintroduce the player's position.
